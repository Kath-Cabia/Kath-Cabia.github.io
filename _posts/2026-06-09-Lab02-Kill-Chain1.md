...
- En la VM de Mestasploitable se ejecuta el comando **ipconfig**, para visualizar la IP asignada a esta máquina virtual.

Resultado:
![Im.1.1](/assets/KILL/Im.1.1.png)
![Im.1.2](/assets/KILL/Im.1.2.png)
...
Resultado:
![Im.2.2](/assets/KILL/Im.2.1.png)
![Im.2.2](/assets/KILL/Im.2.2.png)
...
Resultado:
![Im.3.1](/assets/KILL/Im.3.1.png)
![Im.3.2](/assets/KILL/Im.3.2.png)
![Im.3.3](/assets/KILL/Im.3.3.png)
![Im.3.4](/assets/KILL/Im.3.4.png)
![Im.3.5](/assets/KILL/Im.3.5.png)
![Im.3.6](/assets/KILL/Im.3.6.png)
![Im.3.7](/assets/KILL/Im.3.7.png)


**Si bien es cierto que el anterior escaneo es agresivo**, para un pentesting más completo y metódico, se podrían considerar **otros tipos de escaneos**, como:
...
Son técnicas de reconocimiento que utilizan combinaciones especiales de flags TCP para **identificar puertos abiertos de forma más discreta**. Se emplean como alternativa al **escaneo SYN** cuando se busca evitar ciertas restricciones o mecanismos básicos de detección en la red.

    nmap -sF, -sN, -sX

Resultado:
![Im.7.1](/assets/KILL/Im.7.1.png)
![Im.7.2](/assets/KILL/Im.7.2.png)
![Im.7.3](/assets/KILL/Im.7.3.png)
![Im.7.4](/assets/KILL/Im.7.4.png)
...
![Im.10.2](/assets/KILL/Im.10.2.png)
...
![Im.11.2](/assets/KILL/Im.11.2.png)
...
![Im.11.5](/assets/KILL/Im.11.5.png)
...
Resultado:
![Im.13.2](/assets/KILL/Im.13.2.png)
...
En caso de que el archivo no esté disponible, puede descargarse previamente desde Kali Linux a través de su repositorio oficial:
     ...
     https://github.com/lanmaster53/ptscripts/blob/master/windows/vssown.vb
...
![Im.14.1](/assets/KILL/Im.14.1.png)
...
![Im.14.2](/assets/KILL/Im.14.2.png)
...
![Im.14.3](/assets/KILL/Im.14.3.png)
...
![Im.14.5](/assets/KILL/Im.14.5.png)
...
![Im.14.6](/assets/KILL/Im.14.6.png)

Se listan los volúmenes de shadows (vss) existentes:
![Im.14.7](/assets/KILL/Im.14.7.png)
